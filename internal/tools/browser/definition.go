...
**NOTE:**
- Do not use Exec to run agent-browser for normal browser actions; use this Browser tool instead.
- Load the "agent-browser" skill for workflow guidance, then execute browser actions with this "Browser" tool.
`
)
